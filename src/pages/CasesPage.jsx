    ...
    const CaseStudyCard = ({ title, client, industry, challenge, solution, results, imageAlt, icon }) => (
      <motion.div
      ...
      >
        <Card className="overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 h-full flex flex-col">
          <div className="relative h-56 bg-gray-200">
            <img  class="w-full h-full object-cover" alt={imageAlt} src="https://images.unsplash.com/photo-1694388001616-1176f534d72f" />
            <div className="absolute top-4 right-4 bg-edcap-orange text-white p-3 rounded-full shadow-md">
              ...
              <ul className="list-none space-y-1 text-sm">
                {results.map((result, index) => (
                  <li key={index} className="flex items-start">
                    <CheckCircle className="h-4 w-4 text-edcap-green mr-2 mt-0.5 flex-shrink-0" />
      ...
      const caseStudies = [
        {
          ...
          imageAlt: "Industrial machinery in a metalworking factory",
          icon: <BarChartBig />
        },
        {
          ...
          imageAlt: "Warehouse with shelves stocked with products for e-commerce",
          icon: <Zap />
        },
        {
          ...
          imageAlt: "Diverse team collaborating in a modern office space",
          icon: <Users />
        },
         {
          ...
          imageAlt: "Display of food products in a supermarket or production line",
          icon: <TrendingUp />
        }
      ];
...
title="Cases de Sucesso EDCAP"
          ...
          <Section id="cta-cases" className="bg-gradient-to-r from-edcap-orange to-orange-500 text-white">
