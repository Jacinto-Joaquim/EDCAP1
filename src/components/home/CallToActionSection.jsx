      ...
      <Section className="bg-gradient-to-r from-edcap-orange to-orange-500 text-white" id="cta">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-10 text-orange-100">
            Não espere mais para alcançar o potencial máximo do seu negócio. Solicite um diagnóstico gratuito e descubra como a EDCAP pode ajudar sua empresa a crescer e prosperar.
          </p>
